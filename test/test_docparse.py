...
class DocParseTestCase(unittest.TestCase):
    ...
    def test_generate_help(self):
        ...
        footer = "Use ro_bot, robot, Ro' Bot <command> --help to know more"
    ...
    def test_parse_message_invalid_command(self):
        parsed = docparse.parse_message('ro_bot henlo', 'robot', 'robot_bot')
    ...
    def test_parse_message_no_mention(self):
        parsed = docparse.parse_message(
            f'ro_bot {test_script_python} test-arg', 'robot', 'robot_bot')
        args = parsed[2]
        self.assertEqual(['test-arg'], args['<args>'])
        self.assertEqual(test_script_python, args['<command>'])

    def test_run_subprocess(self):
        parsed = docparse.parse_message(f'ro_bot {test_script_python} test-arg', 'robot', 'robot_bot')
    ...
    def test_parse_subcommand_help(self):
        parsed = docparse.parse_message(f'ro_bot {test_script_python} --help', 'robot', 'robot_bot')
        args = parsed[2]
    ...
    def test_run_subprocess_no_python(self):
        parsed = docparse.parse_message('ro_bot shell', 'robot', 'robot_bot')
        properties, command, arguments = parsed
        self.assertIn(
            'success',
            docparse.run_subprocess(command, arguments, -1, properties)[0]['content'])
    ...
    def test_run_subprocess_stderr(self):
        parsed = docparse.parse_message(f'ro_bot {test_script_python} -e', 'robot', 'robot_bot')
        properties, command, arguments = parsed
        self.assertIn(python.error_message,
                      docparse.run_subprocess(command, arguments, -1, properties)[0]['content'])

    def test_parse_message_json(self):
        parsed = docparse.parse_message('ro_bot json', 'robot', 'robot_bot')
        properties, command, arguments = parsed
    ...
    def test_parse_message_timeout(self):
        parsed = docparse.parse_message('ro_bot timeout', 'robot', 'robot_bot')
        properties, command, arguments = parsed
    ...
    def test_run_subprocess_large_output(self):
        parsed = docparse.parse_message('ro_bot large_output', 'robot', 'robot_bot')
        properties, command, arguments = parsed
    ...
    def test_parse_message_schedule(self):
        parsed = docparse.parse_message('ro_bot cronned', 'robot', 'robot_bot')
        properties, command, arguments = parsed
        self.assertEqual(properties['schedule'], cronned.schedule)

    def test_parse_message_quotes_upcase(self):
        argument = 'someArg'
        parsed = docparse.parse_message(f'ro_bot cronned "{argument}"', 'robot', 'robot_bot')
        properties, command, arguments = parsed
    ...
    def test_parse_message_no_schedule(self):
        parsed = docparse.parse_message('ro_bot python', 'robot', 'robot_bot')
        properties, command, arguments = parsed
